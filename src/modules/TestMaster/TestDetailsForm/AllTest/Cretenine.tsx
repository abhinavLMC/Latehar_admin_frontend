...
const Cretenine = () => {
  ...
  const submitHandler = (Values: FormFields) => {
    submit("/api/cretenine-update", Values, TEST_MASTER_ROUTE);
  };
      ...
      {loading ? (
        ...
        <Form form={form} layout="vertical" onFinish={submitHandler}>
          <div className="form-content">
            <h4 className="primary-color primary-bg-color-4">Creatinine</h4>
            <Row gutter={16}>
              <Col md={12} span={24}>
                <FormItemWrapper
