...
import { CardWrapper, InputWrapper, UploadWrapper, ButtonWrapper, FormItemWrapper } from "@components/Wrapper";
...
const ECG = () => {
  ...
  const submitHandler = (Values: FormFields) => {
    submit("/api/ecg-update", Values, TEST_MASTER_ROUTE);
  };
        ...
        <Form form={form} layout="vertical" onFinish={submitHandler}>
          <div className="form-content">
            ...
            <Row gutter={16}>
              ...
              {/* <Col md={24} span={24}>
                <CommonUploadWrapper
                  {...{ form, label: "Attach Report", name: "document" }}
                />
              </Col> */}
            </Row>
          </div>
