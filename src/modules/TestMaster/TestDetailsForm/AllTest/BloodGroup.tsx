...
const BloodGroup = () => {
  ...
  useEffect(() => {
    fetchData("/api/blood-group-view", {});
  }, []);
  ...
  const submitHandler = (Values: FormFields) => {
    submit("/api/blood-group-update", Values, TEST_MASTER_ROUTE);
  };
      ...
      {loading ? (
        ...
        <Form form={form} layout="vertical" onFinish={submitHandler}>
          <div className="form-content">
            <h4 className="primary-color primary-bg-color-4">Blood Group</h4>
            <Row gutter={16}>
              <Col md={12} span={24}>
              ...
              <Col md={12} span={24}>
                <FormItemWrapper label="Option 4" name="option_4">
                  <InputWrapper />
                </FormItemWrapper>
              </Col>
              <Col md={12} span={24}>
                <FormItemWrapper label="Option 5" name="option_5">
                  <InputWrapper />
                </FormItemWrapper>
              </Col>
              <Col md={12} span={24}>
                <FormItemWrapper label="Option 6" name="option_6">
                  <InputWrapper />
                </FormItemWrapper>
              </Col>
              <Col md={12} span={24}>
                <FormItemWrapper label="Option 7" name="option_7">
                  <InputWrapper />
                </FormItemWrapper>
              </Col>
              <Col md={12} span={24}>
                <FormItemWrapper label="Option 8" name="option_8">
                  <InputWrapper />
                </FormItemWrapper>
              </Col>
            </Row>
