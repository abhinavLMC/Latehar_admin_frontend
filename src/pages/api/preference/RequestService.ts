...
import { downloadPrescriptionPdf } from '@utils/commonFunctions'
...
/**
 * Download a prescription PDF by ID
 * This is a wrapper around the common utility function
 * 
 * @param {string} prescriptionId - The ID of the prescription to download
 * @returns {void} - Opens the PDF in a new browser tab
 */
export const downloadPrescriptionPdfService = (prescriptionId: string): void => {
